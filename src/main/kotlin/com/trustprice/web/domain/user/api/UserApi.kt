package com.trustprice.web.domain.user.api

import com.trustprice.web.domain.user.application.UserHistoryService
import com.trustprice.web.domain.user.application.UserService
import com.trustprice.web.domain.user.dto.*
import com.trustprice.web.domain.user.dto.request.AuthenticationRequest
import com.trustprice.web.domain.user.dto.request.GetUserHistoryRequest
import com.trustprice.web.domain.user.dto.response.*
...
class UserApi(
    ...
    fun findUserList(): ResponseEntity<FindUserListResponse> {
        ...
        return ResponseEntity.ok()
            .body(
                FindUserListResponse("전체 유저 조회 완료", Responses.OK, userList.map { UserDto.from(it) }),
            )
    }
    ...
    fun getUserCount(
        @ModelAttribute getUserHistoryRequest: GetUserHistoryRequest,
    ): ResponseEntity<FindUserHistoryResponse> {
