...
class DiscordUserInfo(user: OAuth2User) : OAuth2UserInfo {
    ...
    override val profileImage =
        "https://cdn.discordapp.com/avatars/${attributes["id"]}/${attributes["avatar"]}.png"
    override val claims =
        mapOf("id" to id, "email" to email, "name" to name, "profile_image" to profileImage, "provider" to provider)
}
